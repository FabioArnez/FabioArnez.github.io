...
date: 2020-04-07
tags: BayesianNeuralNetworks UncertaintyEstimation ApproximateBayesianInference
categories: deep-learning-uncertainty
...
tikzjax: true
thumbnail: assets/img/posts/2020-04-06-Approx-Bayesian-Inference-BNNs/BNNs-image.png
citation: true
toc:
  sidebar: left
#   - name: Deep Neural Networks Uncertainty
#   - name: 
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/2020-04-06-Approx-Bayesian-Inference-BNNs/BNNs-image.png" class="img-fluid rounded z-depth-1" zoomable=true caption="Figure 1: Deterministic Neural Network vs Bayesian Neural Network"%}
    </div>
</div>

<!-- ![Figure 1: Deterministic Neural Network vs Bayesian Neural Network](/BNNs-image.png)
_Figure 1: Deterministic Neural Network vs Bayesian Neural Network_ -->
